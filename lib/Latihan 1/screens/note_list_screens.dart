...
class _NoteListScreenState extends State<NoteListScreen> {
  ...
  void initState() {
    super.initState();
    _loadNotes(); // Load data saat aplikasi dibuka
  }
  ...
  void _addNote(String title, String content) {
    ...
    _saveNotes(); // Simpan setiap kali ada perubahan
  }
          ...
          IconButton(
            ...
            onPressed: () {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Total: ${notes.length} catatan')),
              );
            },
          ),
        ],
          ...
          ElevatedButton(
            onPressed: () {
              if (titleController.text.isNotEmpty &&
                ...
                if (isEdit) {
                  _updateNote(index, titleController.text,
